package com.example.familytree.adapters;
...
public class AdapterPosts extends RecyclerView.Adapter<com.example.familytree.adapters.AdapterPosts.MyHolder> {
    ...
    public AdapterPosts(Context context, List<Post> modelPosts) {
