...
/**
 * Min Heap is CBT. All levels full except the leaf/last node level where filled from left. All leaves have same depth
 ...
 * MinHeap properties - child node value greater or equal to parent value. If after insertion a value, propery is voilated, we need to correct until root.
...
public class Heaps {
    ...
    private void minHeapify(int pos) {
        // Choose the minimum of childs(left or right), and swap with parent.
